...
const provision = {
  ...
  overviewParagraphs: [
    "Our EBSA support is designed for young people who struggle to attend school due to anxiety, trauma, emotional distress or complex needs.",

    "We work with families, schools and local authorities to rebuild confidence gradually, using a child-centred and trauma-informed approach.",

    "Every plan is personalised around the individual child, helping them regain stability, confidence and long-term educational engagement.",
  ],
  ...
  features: [
    {
      ...
      text: "Support that recognises anxiety, trauma and emotional barriers to attendance.",
    },

    {
      icon: "🏫",
      title: "School Re-engagement",
      text: "Gradual pathways back into learning based on the young person's readiness and wellbeing.",
    },

    {
      icon: "🤝",
      title: "Multi-agency Working",
      text: "Collaboration with schools, local authorities, families and wider professionals involved in the young person's care.",
    },
  ],
};
