...
const provision = {
  ...
  overviewParagraphs: [
    "Our supported accommodation provides a safe and structured environment for young people who require guidance, stability and ongoing support.",

    "We focus on helping young people develop independence skills, emotional resilience and positive routines within a nurturing setting.",

    "Every support plan is personalised around the young person's needs, goals and long-term transition into adulthood.",
  ],
  ...
  features: [
    {
      ...
      text: "Stable, supportive living environments designed around safeguarding and wellbeing.",
    },

    {
      icon: "🧭",
      title: "Independence Skills",
      text: "Support with routines, budgeting, appointments, cooking, education and daily living.",
    },

    {
      icon: "🛡️",
      title: "24/7 Support",
      text: "Consistent guidance and professional support to help young people feel safe and supported.",
    },
  ],
};
