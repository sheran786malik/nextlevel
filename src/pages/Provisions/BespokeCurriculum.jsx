...
const provision = {
  ...
  heroText:
    "Personalised learning pathways designed around each young person's needs, strengths and future goals.",

  overviewTitle:
    "Education built around the individual, not the system.",

  overviewParagraphs: [
    "Our bespoke curriculum provision is designed for young people who require flexible, personalised learning approaches to re-engage with education and achieve meaningful progress.",

    "We adapt educational pathways around each young person's academic level, emotional wellbeing, interests and long-term aspirations.",

    "The focus is on creating learning experiences that build confidence, consistency and positive outcomes in a way that feels achievable and supportive.",
  ],
  ...
  features: [
    {
      ...
      text: "Curriculum pathways tailored around ability, interests, learning style and educational goals.",
    },

    {
      icon: "🎯",
      title: "Outcome-Focused Support",
      text: "Structured educational support designed to improve engagement, confidence and long-term progression.",
    },

    {
      icon: "🧠",
      title: "Holistic Approach",
      text: "Combining academic learning with emotional wellbeing, personal development and life skills.",
    },
  ],
};
